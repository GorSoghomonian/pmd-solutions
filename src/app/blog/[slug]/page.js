...
import ErrorBoundary from "../../../components/common/ErrorBoundary"; // fixed path
import Image from "next/image";
import BlogPostCard from "../../../components/molecules/BlogPostCard";
import BlogFooter from "../../../components/organsim/BlogFooter";

// Removed 'use client' so we can use server APIs safely
...
export default async function Page(props) {
  ...
  return (
    <section>
      {/* Replaced undefined ErrorBoundaryHandler with existing ErrorBoundary */}
